...
function create_Service(
  candidate: Candidate,
): EliminateCandidateBeforeSuspentions {
...
describe('Eliminate a candidate before x suspentions service', () => {
  it('should succeed after x suspentions of candidate', () => {
    ...
    const actualService = create_Service(actualCandidate);
  ...
  it('candidate should have state: Eliminated', () => {
    ...
    expect(actualCandidate.state).toHaveProperty(
      'state',
      CandidateStatesEnum.Eliminated,
    );
  });
});
