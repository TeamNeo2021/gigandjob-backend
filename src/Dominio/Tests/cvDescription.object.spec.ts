...
describe("CV Work Experience", () => {
    ...
    it("should not create when description has more than 500 characters", () => {
        ...
        expect(() => new CvDescription(description)).toThrowError(InvalidCvDescriptionError)
    })
    it("should create when description is valid", () => {
        expect(new CvDescription("Some valid description")).toBeInstanceOf(CvDescription)
    })
})
