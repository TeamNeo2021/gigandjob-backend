...
describe('Reactivar oferta', () => {
  ...
  it('Se debe Reactivar una oferta si ha sido suspendida', () => {
    ...
    expect(exampleOfferReactived.GetChanges()[1]).toBeInstanceOf(
      OfferSuspended,
    );
    expect(exampleOfferReactived.GetChanges()[2]).toBeInstanceOf(
      OfferReactivated,
    );
  });
...
describe('Eliminar oferta', () => {
  ...
  it('Se debe eliminar una oferta que ha sido suspendida', () => {
    ...
    expect(exampleOfferEliminited.GetChanges()[1]).toBeInstanceOf(
      OfferSuspended,
    );
    expect(exampleOfferEliminited.GetChanges()[2]).toBeInstanceOf(
      OfferEliminated,
    );
  });
