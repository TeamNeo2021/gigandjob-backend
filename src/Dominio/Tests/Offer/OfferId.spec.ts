...
describe('Offer ID', () => {
  ...
  it('No debería crear si el Id es vacio', () => {
  ...
  it('No debería crear si el Id es de formato incorrecto', () => {
    ...
    expect(
      () => new OfferIdVO('4992c888-2e37-4d66-945b-b29ed3aa'),
    ).toThrowError(InvalidOfferId);
    expect(
      () => new OfferIdVO('4992c888-2e37-4d66945b-b29ed3aa7720'),
    ).toThrowError(InvalidOfferId);
    expect(
      () => new OfferIdVO('4992c888-2e37-4d66-945b-b29zd3aa7720'),
    ).toThrowError(InvalidOfferId);
  });
  ...
  it('Debería crear si le paso un uuid correcto', () => {
    expect(
      new OfferIdVO('4992c888-2e37-4d66-945b-b29ed3aa7720'),
    ).toBeInstanceOf(OfferIdVO);
  });
});
