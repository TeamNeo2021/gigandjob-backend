...
import {
  ApplicationState,
  ApplicationStates,
} from '../../../AggRoots/Offer/Application/Value Objects/ApplicationStates';
import { ApplicationTime } from '../../../AggRoots/Offer/Application/Value Objects/ApplicationTime';

const exampleApplier: Function = () => {};
const exampleBudget = 500;
const exampleDescription = 'Hi im a perfect description';
const exampleTimeInDays = 10;
const exampleOverflowedDescription =
...
describe('Creating an application', () => {
  ...
  it('should fail when description is larger than 500 characters', () => {
    expect(
      () => new ApplicationDescription(exampleOverflowedDescription),
