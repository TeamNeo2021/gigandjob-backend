...
export class InvalidOfferDirection extends Error {
    ...
    static latitudeOutOfRange() {
        return new InvalidOfferDirection("Latitude is out of range, possible values [-90,90]")
    }  
    static longitudeOutOfRange() {
        return new InvalidOfferDirection("Longitude is out of range, possible values [-180,180]")
    }  
