export class InvalidEmployerLocation extends Error {
    ...
    static latitudeOutOfRange() {
        return new InvalidEmployerLocation("Latitude is out of range, possible values [-90,90]")
    }  
    static longitudeOutOfRange() {
        return new InvalidEmployerLocation("Longitude is out of range, possible values [-180,180]")
    }  
